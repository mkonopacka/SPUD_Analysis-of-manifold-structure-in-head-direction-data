...
accumulates spikes, angles and state information into a single Python friendly structure.
...
if make_processed_files:
    ...
    gff.save_pickle_file(data, save_dir + f"{session}_processed.pkl") # changed to pkl
